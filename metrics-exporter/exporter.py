...
max_players = Gauge(
    'game_max_players',
    'Maximum player capacity of the game server',
    ['server_id']
)
tps = Gauge(
    'game_tps',
    'Server ticks per second (20 = healthy for Minecraft)',
    ['server_id']
)
memory_used = Gauge(
...
uptime_seconds = Gauge(
    'game_uptime_seconds',
    'How long the game server has been running',
    ['server_id']
)
...
server_info = Info(
    'game_server',
    'Static information about the game server',
    ['server_id']
)
